...
export default function LoginPage() {
  ...
  async function submitLogin(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const payload = await response.json() as { data: { mfa_required: boolean } };
      if (payload.data.mfa_required) setPhase("mfa"); else router.push("/dashboard");
